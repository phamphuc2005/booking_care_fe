...
class ModalCancelAppointment extends Component {
    ...
    handleCancelAppointment = () => {
        this.props.cancelAppointmentModal(this.state);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalCancelAppointment);
